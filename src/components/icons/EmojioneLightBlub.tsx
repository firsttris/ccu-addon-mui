...
export function EmojioneLightBulb(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill="#616466" d="M28 58c0 2.2 1.8 4 4 4s4-1.8 4-4z"></path>
      <path
        fill="#ffce31"
